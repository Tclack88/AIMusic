...
filtered_results = filter_results(Identified_Notes)


filtered_results2 = [note for note in Identified_Notes if note != 'C0']

print(filtered_results, filtered_results2)
# remove last portion (the letter) because octave doesn't matter in this code
